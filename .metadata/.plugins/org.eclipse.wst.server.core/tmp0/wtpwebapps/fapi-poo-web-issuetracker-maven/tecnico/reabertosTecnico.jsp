				...
				<div class="row">
					...
					<div class="col-md-9">
						<div id="teste" class="col-md-12" style="background-color: white;">
							<div class="main">
								<div class="container">
									<h2>Tickets Reabertos</h2>
									<p>
										<strong>Note:</strong> <span class="badge bg-primary m-0">Reaberto</span>
									</p>
													...
													<a data-toggle="collapse" data-parent="#accordion"
														...
														<table class="table table-hover mb-0 ">
															<tr class="table">
																...
																<td class="col-md-3">Janeiro 13, 2019</td>
																...
																<td class="col-md-2"><button type="button"
																		class="btn btn-success">Resolver</button></td>
															</tr>
														</table>
													</a>
												</h4>
