					...
					<div class="col-md-9">
						<div id="teste" class="col-md-12" style="background-color: white;">
							...
							<div class="container">
								...
								<form class="form-horizontal" method="POST" action="/fapi-poo-web-issuetracker-maven/TicketsServlet?acao=cadastrarTickets">
									<div class="row">
										<div class="form-group col-md-3">
											<i class="fa fa-user"></i> <label for="nome">Usuario
											</label> <input type="text" class="form-control" id="nome"
												aria-describedby="nomeHelp" value=" Bruno" disabled>
											<small id="nomeHelp" class="form-text text-muted">Nome
												do usuario logado no momenmto.</small>
										</div>
										<div class="col-md-2"></div>
										<div class="form-group col-md-3">
											<i class="fa fa-envelope"> </i> <label for="nome">Email</label>
											<input type="text" class="form-control" id="nome"
												aria-describedby="nomeHelp"
												value="bruno@fapi-pinhais.edu.br" disabled> <small
									...
									<div class="row">
										<div class="form-group col-md-8">
											<i class="fa fa-group"> </i> <label for="nome">Assunto</label>
											<input type="text" class="form-control" id="nome"
												aria-describedby="nomeHelp"
												placeholder="Digite assunto do seu ticket" maxlength="25">
											<small id="nomeHelp" class="form-text text-muted">
												Numero maximo caracteres 25.</small>
										</div>
									</div>
									<div class="row">
										<div class="form-group col-md-8">
											<i class="fa fa-comments-o"> </i> <label
												for="exampleTextarea">Descrição</label>
											<textarea class="form-control" id="exampleTextarea" rows="3"
												placeholder="Descreva qual é seu problema"></textarea>
										</div>
									</div>
