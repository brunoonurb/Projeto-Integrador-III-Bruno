...
<body>
	...
	<section id="container" class="">
		...
		<header class="header dark-bg">
			<!--logo start-->
			<a href="cliente/home.jsp" class="logo">Issue <span class="lite">Tracker</span></a>
			<!--logo end-->
				...
				<div class="row">
					...
					<div class="col-md-9">
						<div id="teste" class="col-md-12" style="background-color: white;">
							...
							<div class="container">
								<h2>
									<i class="fa fa-info-circle" aria-hidden="true"></i> Tickets
									Pendentes
								</h2>
								<p>
									<strong>Note:</strong> Tickets <strong><span
										class="badge bg-warning m-0">Pendente</span> </strong>
								</p>
													...
													<table class="table table-hover mb-0 ">
														<tr class="table">
															...
															<td class="col-md-2"><button type="button"
																	class="btn btn-success">Reabrir</button></td>
														</tr>
													</table>
												</a>
											</h4>
