						...
						<div id="teste" class="col-md-12" style="background-color: white;">
							<div class="main">
								<div class="container">
									...
									<p>
										<strong>Note:</strong> <span class="badge bg-warning m-0">Pendente</span>
									</p>


									<div class="panel-group " id="accordion">

										<!-- AQUI COMECA A LINHA TABELA-->
														...
														<table class="table table-hover mb-0 ">
															<tr class="table">
																...
																<td class="col-md-2"><span
																	class="badge bg-warning m-0">Pendente Técnico</span></td>
																<td class="col-md-4">Problema de acesso</td>
													...
													<a data-toggle="collapse" data-parent="#accordion"
														...
														<table class="table table-hover mb-0 ">
															<tr class="table">
																...
																<td class="col-md-2"><span
																	class="badge bg-warning m-0">Pendente Usuário</span></td>
																<td class="col-md-4">Problema notificações</td>
																<td class="col-md-2"><button type="button"
																		class="btn btn-success">Resolvido</button></td>
															</tr>
														</table>
